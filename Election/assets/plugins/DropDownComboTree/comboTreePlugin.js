    ...
    if (isThereSubs)
      itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '<span class="mdi mdi-chevron-right-circle-outline"></span>' : '<span class="mdi mdi-chevron-down-circle-outline"></span>') + '</span>'; // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') + '</span>';
        ...
        if (this.options.isMultiple)
            ...
            if (!sourceItem.SelectedTree ) {
                itemHtml += '<span data-id="' + sourceItem.id + '" data-selectable="' + false + '" class="comboTreeItemTitle ' + selectableClass + '" style="background-color:#ef8888;">' + sourceItem.title + '</span>';
            } else if (sourceItem.ShowAllLevel){
                itemHtml += '<span data-id="' + sourceItem.id + '" data-selectable="' + isSelectable + '" class="comboTreeItemTitle ' + selectableClass + '" style="background-color:#7cb038;">' + sourceItem.title + '</span>';
            }
            else
